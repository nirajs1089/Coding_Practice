In this challenge, you will be given an array of integers, each unique within the array, and an integer representing a target difference. You must determine the number of pairs of elements in the array that have a difference equal to the target difference.
...
We must count the number of pairs in a = [1, 5, 3, 4, 2] whose difference is k = 2. We find the following three pairs: (1, 3), (5, 3), and (4, 2).
